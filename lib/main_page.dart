...
class Main_Page extends StatelessWidget {
  ...
  List<String> heading=["Skin","Gynae","Ent","Dental","Physiotherapy","Medicine","Paediatrician","Laboratory and Diagnostic","Diet and Nutrtion","See More Specialities"];
  @override
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Row(
                children: [
                  SizedBox(
                    width: (mediaQueryData.size.width / 360 ) * 10,
                  ),
                  Container(
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                            blurRadius: 6, color: Colors.grey, spreadRadius: 0)
                      ],
                    ),
                  ...
                  SizedBox(
                    width: (mediaQueryData.size.width / 360 ) * 90 ,
                  ),
                  Container(
                    decoration: BoxDecoration(
                      color: Colors.white,
                  ...
                  children: <Widget>[
                    Stack(
                      children: [
                        Card(
                          ...
                          child: Padding(
                            ...
                            child: Container(
                              ...
                              height: (mediaQueryData.size.height / 640 ) * 150,
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: <Widget>[
                        ...
                        Positioned(
                          top: (mediaQueryData.size.height / 640 ) * 7.0,
                          right: (mediaQueryData.size.width / 360 ) * 0,
                          child: Card(
                            color: Colors.yellow[700],
                            child: Padding(
                        ...
                        Positioned(
                            top: (mediaQueryData.size.height / 640 ) * 87,
                            right: (mediaQueryData.size.width / 640 ) * 22,
                            child: Image.asset('assets/swab.jpg',scale: 6,))
                      ],
                    ),
                    Stack(
                      children: [
                        ...
                        Positioned(
                          right: (mediaQueryData.size.width / 360 ) * 00,
                          top: (mediaQueryData.size.height / 640 ) * 7.0,
                          child: Card(
                            color: Colors.yellow[700],
                            child: Padding(
                        ...
                        Positioned(
                            top: (mediaQueryData.size.height / 640 ) * 85,
                            right: (mediaQueryData.size.width / 360 ) * 7,
                            child: Image.asset('assets/dad_daughter.jpg',scale: 5,))
                      ],
                    ),
                  ],
                ),
                    ...
                    return Container(
                      child: Stack(
                        children: <Widget>[
                          Column(
                            children: [
                              heading[index] != "See More Specialities" ? Card(
                                color: card_colors[0],
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                                child: Container(
                                  width: (mediaQueryData.size.width / 360) * 110,
                                  height: (mediaQueryData.size.height / 640) *110,
                                ),
                              ) : Card(
                                color: Colors.white,
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                              ...
                              Text(heading[index],textAlign:TextAlign.center,style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,
                              fontSize: 13),),
                            ],
                          ),
                          heading[index] != "See More Specialities" ? Positioned(
                            top:(mediaQueryData.size.height /640 ) * 13,
                              right: (mediaQueryData.size.width / 360) *8,
                              child: Image.asset('assets/doctor_small_image.jpg',scale: 5.2,)) :
                          Positioned(
                              top:(mediaQueryData.size.height /640 ) *40,
                              right:(mediaQueryData.size.width / 360)* 10,
                              left:(mediaQueryData.size.width / 360)* 10,
                              child: Text('See More Specialities',textAlign: TextAlign.center,style: TextStyle(color: Colors.blue[500],fontWeight: FontWeight.bold),)),
                        ],
                      ),
                    );
                  },
